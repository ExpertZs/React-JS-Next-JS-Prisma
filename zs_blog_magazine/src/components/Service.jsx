    ...
    <section className="pt-20">
      <div className="container  mx-auto">
        <div className="max-w-lg mx-auto mb-16 text-center">
          <h2 className="mb-4 text-4xl font-bold font-heading">Services</h2>
          <p className="text-gray-400 leading-loose">
            This is Service page. Please check our service
          </p>
        </div>
        <div className="grid grid-cols-12 gap-[30px] -mx-3">
          {data.map((item, index) => (
            <div
              key={index}
              className=" col-span-3 rounded-xl px-[20px] py-[50px] mb-20 shadow-xl"
            >
              <img
