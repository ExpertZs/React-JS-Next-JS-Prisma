          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap">
              <div className="w-full lg:w-1/3 mb-16 lg:mb-0">
                <h1 className="text-white text-5xl font-bold"> Blog Magazine</h1>
                <p className="mb-4 max-w-sm text-white leading-loose">
                  Some footer text about the Magazine. Just a little description
              ...
              <div className="w-full lg:w-2/3 lg:pl-16 flex flex-wrap justify-between">
                ...
                <div className="w-full md:w-1/3 lg:w-auto">
                  ...
                  <p className="text-white">
                    Blog Magazine Head Office. Airport Road United Arab Emirate
                  </p>
                </div>
              </div>
            </div>
            <p className="lg:text-center text-sm text-white border-t border-gray-100 pt-12 mt-16">
              Copyright Blog Magazine @2023
            </p>
          </div>
        </div>
      </section>
